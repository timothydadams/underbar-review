  ...
  describe('Part I', function() {
    ...
    describe('pluck', function() {
      ...
      it('should return values contained at a user-defined property', function() {
        ...
        expect(_.pluck(people, 'name')).to.eql(['moe', 'curly']); //eql vs equal
      });
      ...
      it('should not modify the original array', function() {
        ...
        expect(people).to.eql([{ name: 'moe', age: 30 }, { name: 'curly', age: 50 }]); //MIGHT HAVE TO RELOOK EQL
      });
    });
    ...
    describe('reduce', function() {
      ...
      it('should pass items of the array into the iterator from left to right', function() {
        ...
        _.reduce([1, 2, 3, 4], function(memo, item) {  //memo = accumlator
